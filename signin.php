...
<body>
    ...
    <form style="text-align:center;" method="post" action="">
        <input style="margin-bottom:15px;width:30%;text-align:center;" type="text" name="name"
            placeholder="name here"><br>
        <input style="margin-bottom:15px;width:30%;text-align:center;" type="password" name="password"
            placeholder="password here"><br>
        <button style="width:30%;text-align:center;" name="submit" type="submit">click to submit!</button>
        <br><span style="color:red;">
            <?= $outcome->errors['confirmation']; ?>
        </span>
    </form>
</body>
